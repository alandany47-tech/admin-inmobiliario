 ...
 */
/**
 * Comparador de orden natural para códigos WBS tipo "1.10.2" vs "1.2.9":
 * compara segmento por segmento como números en vez de como texto, para que
 * 1.10 quede después de 1.2 y no antes (orden lexicográfico ingenuo fallaría
 * ahí). Los códigos ausentes (null) siempre se consideran "mayores" que
 * cualquier código real, sin importar la dirección de orden (asc/desc) que
 * aplique el llamador sobre el resultado.
 */
